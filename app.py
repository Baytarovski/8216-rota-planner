...
def display_latest_rota(rotas):
    ...
    if latest_week:
        ...
        st.image(image_buf, caption="Sample Table", use_container_width=True)        st.download_button(
