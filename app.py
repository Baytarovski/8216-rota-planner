...
if is_admin:
    st.markdown("<h3 style='margin-bottom:0em;'>🛠️ Admin Panel</h3>", unsafe_allow_html=True)
    st.markdown("<hr style='margin-top:0em; margin-bottom:1em; border: 2px solid black;'>", unsafe_allow_html=True)
