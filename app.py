...
""", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align:left; color:#666; font-size:0.95em; margin-top:-1em; margin-bottom:1em;'>🗓️ Planning Week: <strong>{week_range}</strong></div>", unsafe_allow_html=True)
    daily_workers = {}
    daily_heads = {}
    daily_raw_selected = {}
    daily_raw_head = {}
